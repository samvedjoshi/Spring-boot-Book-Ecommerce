...
public class HomeController {
	...
	public String bookDetail(
		...
		newbook.setId((long)153);
		newbook.setAuthor("William Baker");
		newbook.setCategory("Programming");
		newbook.setDescription("This is a very nice book");
		newbook.setInStockNumber(35);
		newbook.setLanguage("English");
		newbook.setPublisher("Navneet");
		newbook.setPublicationDate("23-12-2018");
		newbook.setOurPrice(566);
		newbook.setListPrice(870);
		newbook.setNumberOfPages(456);
		newbook.setTitle("Investing in our future");
	...
	public String newUserPost(
		...
		String appUrl = "http://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath();
		System.out.println("//////////////////////////////////////////////////////////////////////////////////////////"+appUrl+" "+request.getLocale()+token+" "+user+" "+password);
